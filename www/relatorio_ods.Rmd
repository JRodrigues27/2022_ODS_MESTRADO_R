...
Os eixos PAVS são bem abrangentes e, para os profissionais que não tiveram em suas formações a oportunidade de apreender e discutir sobre a relação saúde e ambiente, se apresentam como muito difuso. O próprio conceito de saúde ambiental é um terreno em disputa. Não é a intenção deste documento se debruçar sobre uma discussão epistemológica, mas uma conceituação bem didática pode ser encontrada no site da Fundação Nacional de Saúde como se vê a seguir. 
...
Avaliando os eixos PAVS, as intervenção das equipes das UBS para o PAVS nos últimos 10 anos e a luz do conceito de saúde ambiental, os Assessores Técnicos de Meio Ambiente do Santa Marcelina Saúde ^[Assessores Técnicos: Jefferson S. R, Paulo José B. V., Paulo Roberto P.P.] relacionaram as seguintes possibilidades de intervenções práticas sob o âmbito do PAVS^[Com excessão dos Projetos e ações visando atender aos objetivos da "Agenda Ambiental na Administração Pública (A3P)" e  o "Mais saúde, menos plástico", que têm a intenção de reduzir o impacto ambiental decorrente das atividades da unidade de saúde, todos os outros são relacionados à saúde ambiental]. Essas intervenções foram agrupadas segundo os grupos e as linhas de cuidado mais afetadas pelos riscos ambientais [@Corvalan2016 p86] e os determinantes socioambientais discriminados no conceito:
...
Cada tipo de intervenção, a depender pode ser relacionada em um eixo PAVS ou mais. No caso de `r params$acoes`, relacionou-se como abaixo:  
...
Tendo com maior clareza os tipos de intervenção possívelmente relacionadas aos aspectos e riscos ambientais, pode-se agrupar também os agravos e doenças que poderiam ser enfrentadas com elas. Com este trabalho foi possivel então relacionar as intervenções, e depois agrupar segundo Eixos PAVS as sugestões de ações para entrentamento da OMS, em seu relatório.
